        ...
        var VirtualList = function (listBlock, params) {
            ...
            vl.setListSize = function () {
                ...
                if (dynamicHeight) {
                    ...
                    listHeight = (Math.ceil(items.length /  vl.params.cols) * vl.params.height) + vl.params.add_height;
                    rowsPerScreen = Math.ceil(pageHeight / vl.params.height);
                    rowsBefore = vl.params.rowsBefore || rowsPerScreen * vl.params.item_multiplier;
                    rowsAfter = vl.params.rowsAfter || rowsPerScreen;
                    rowsToRender = (rowsPerScreen + rowsBefore + rowsAfter);
                    maxBufferHeight = rowsBefore / vl.params.item_multiplier * vl.params.height;
                }
            ...
            // Render items
            vl.render = function (force, forceScrollTop,callback) {
                ...
                //Call this callback after rendering list items
            ...
            // Init Virtual List
            vl.init = function (callback) {
                vl.attachEvents();
                vl.setListSize();
                vl.render(null,null,callback);
            };
